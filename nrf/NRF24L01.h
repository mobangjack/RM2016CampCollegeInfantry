...
#define RCC_NRF24L01_CSN  RCC_AHB1Periph_GPIOA

#define NRF24L01_IRQ      GPIO_Pin_7
#define GPIO_NRF24L01_IRQ  GPIOA
#define RCC_NRF24L01_IRQ  RCC_AHB1Periph_GPIOA

//NRF2401片选信号
#define RESET_NRF24L01_CE()    GPIO_ResetBits(GPIO_NRF24L01_CE,NRF24L01_CE)
#define SET_NRF24L01_CE()      GPIO_SetBits(GPIO_NRF24L01_CE,NRF24L01_CE)

//SPI片选信号	
#define RESET_NRF24L01_CSN()   GPIO_ResetBits(GPIO_NRF24L01_CSN,NRF24L01_CSN)
...
u8 NRF24L01_WriteBuf(u8 regaddr, u8 *pBuf, u8 datalen); //写数据区
u8 NRF24L01_ReadBuf(u8 regaddr, u8 *pBuf, u8 datalen);  //读数据区		  
u8 NRF24L01_ReadReg(u8 regaddr);		                 //读寄存器
u8 NRF24L01_WriteReg(u8 regaddr, u8 data);              //写寄存器
u8 NRF24L01_Check(void);                                 //检查NRF24L01是否在位
u8 NRF24L01_Tx(u8 *txbuf);                              //发送一个包的数据
u8 NRF24L01_Rx(u8 *rxbuf);                              //接收一个包的数据
